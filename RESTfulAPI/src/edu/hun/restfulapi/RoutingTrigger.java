...
//
		...
		System.out.println(JsonTool.jsonStringToList(RestfulTool.getAllFlows()));
//		
		System.out.println("------------Rule------------");
		FlowRule rule = ParsingFlowInformation.bulidFlowRule("de:a2:c3:f1:8f:4a");
...
//		System.out.println("----------getNetworkCalculus-------------");
//		System.out.println(RestfulTool.getNetworkCalculus());
		System.out.println("-------------------------");
		System.out.println(RestfulTool.postFlowInfo("hello floodlight"));
		System.out.println("-------------------------");
		System.out.println(RestfulTool.getFlowInfo());
	}
}
